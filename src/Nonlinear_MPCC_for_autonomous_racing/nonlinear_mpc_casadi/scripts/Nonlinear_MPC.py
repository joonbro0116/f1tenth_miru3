...
class MPC:
    ...
    def solve(self, initial_state):
        ...
        # Debug: print solver output
        print(f"[MPC DEBUG] First control: v={float(con_first[0])}, theta={float(con_first[1])}, p={float(con_first[2])}")
        print(f"[MPC DEBUG] Solver status: {self.solver.stats()['return_status']}")
